 ...
 *
 * <p>For additional documentation, see <a href="http://algs4.cs.princeton.edu/21elementary">Section
...
public class Quick {
  ...
  private static int partition(Comparable[] a, int lo, int hi) {
    ...
    while (true) {
      ...
      while (less(v, a[--j])) if (j == lo) break; // redundant since a[lo] acts as sentinel
  ...
  public static void main(String[] args) {
    ...
    //			Integer ith = (Integer) Quick.select(ar, i);
    //			System.out.println(ith);
    //		}
  }

  static void printArray(Comparable[] ar) {
    for (Comparable n : ar) {
      System.out.print(n + " ");
    }
    System.out.println("");
