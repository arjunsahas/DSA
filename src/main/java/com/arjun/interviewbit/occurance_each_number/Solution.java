 ...
 *
 * <p>Return an array containing only the occurences with the smallest value's occurence first.
 *
 * <p>For example, A = [4, 3, 3], you have to return an array [2, 1], where 2 is the number of
 * occurences for element 3, and 1 is the number of occurences for element 4. But, 2 comes first
...
public class Solution {
  public ArrayList<Integer> findOccurences(ArrayList<Integer> A) {
    ...
    List<Integer> collect =
        countList.stream().map(Map.Entry::getValue).collect(Collectors.toList());
