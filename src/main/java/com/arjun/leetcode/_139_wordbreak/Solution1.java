 ...
 *
 * <p>To speed up this we can do memoisation. Here the memoisation can be of the particular string
 * and the list of tokens map<String,List<String>>
 */
class Solution1 {
