 ...
 *
 * Intuition is to have two pointer and iterate the fast pointer first to a certain position and then iterate the slow ppinter
 * till the end of the fast pointer.
 */
class Solution {
