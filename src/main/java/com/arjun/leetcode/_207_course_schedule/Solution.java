...
class Solution {
    public boolean canFinish(int numCourses, int[][] prerequisites) {
        ...
        Optional<Boolean> reduce = Arrays.stream(resultForTraversal).reduce((aBoolean, aBoolean2) -> aBoolean && aBoolean2);
        return reduce.get();
    }
...
//            addVertexToAdjacencyList(adjacencyList, startVertex, endVertex);
    ...
    public static void main(String[] args) {
        ...
        boolean b = new Solution().canFinish(7, new int[][]{{1, 0}, {0, 3}, {0, 2}, {3, 2}, {2, 5}, {4, 5}, {5, 6}, {2, 4}});
...
//        System.out.println(b);
//
//        b = new Solution().canFinish(6, new int[][]{{0, 1}, {2, 1}, {1, 2}, {2, 3}, {3, 4}, {4, 5}});
//        System.out.println(b);
//
...
//        System.out.println(b);
//
//        b = new Solution().canFinish(20, new int[][]{{0, 10}, {3, 18}, {5, 5}, {6, 11}, {11, 14}, {13, 1}, {15, 1}, {17, 4}});
//        System.out.println(b);
