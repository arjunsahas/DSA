...
public class Solution {
  ...
  public List<String> topKFrequent(String[] words, int k) {
    ...
    maxHeap.sort(
        (o1, o2) -> {
          if (o1.occurrence == o2.occurrence) return o1.value.compareTo(o2.value) > 0 ? -1 : 1;
          else return o1.occurrence - o2.occurrence > 0 ? 1 : -1;
        });
    List<String> strings = new ArrayList<>();
    for (int i = maxHeap.size() - 1; i >= 0; i--) strings.add(maxHeap.get(i).value);
  ...
  private void swap(
      List<HeapNode> maxHeap, int i, HeapNode parentNode, int swapPos, HeapNode biggerSibling) {
  ...
  public static void main(String[] args) {
    ...
    strings =
        new Solution()
            .topKFrequent(
                new String[] {"up", "upstox", "broking", "finance", "stocks", "up", "upstox", "up"},
                4);
    System.out.println(strings);
  }
}
