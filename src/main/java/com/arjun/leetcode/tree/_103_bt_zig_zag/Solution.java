...
class Solution {
    ...
    public static void main(String[] args) {
        ...
        treeNode = new TreeNode(1, new TreeNode(2, new TreeNode(4), null), new TreeNode(3, null, new TreeNode(5)));
        lists = new Solution().zigZagView(treeNode);
        System.out.println(lists);

        treeNode = new TreeNode(3, new TreeNode(4, new TreeNode(-7, new TreeNode(-7), null), new TreeNode(-6, new TreeNode(-5, new TreeNode(-4), null), null)), new TreeNode(5));
        lists = new Solution().zigZagView(treeNode);
        System.out.println(lists);
