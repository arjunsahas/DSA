...
/**
 * The Tree is seen from the top. The intuition is that do a level order along with an awareness of the width of the tree.
 * If the width of the tree is larger, then add the nodes to result. Add null also to count the width
 */
class Solution {
    ...
    public static void main(String[] args) {
        ...
        treeNode = new TreeNode(1, new TreeNode(2, new TreeNode(4), new TreeNode(5)), new TreeNode(3, new TreeNode(6), null));
